...
This standard defines a framework that enables ticketing agents to utilize [ERC-721](../00721.md) tokens as event tickets and restricts token transferability to prevent ticket touting. By implementing this standard, we aim to protect customers from scams and fraudulent activities.
...
3. How to design a smooth ticketing process？
   ...
   * Void Flow
        ![Alt text](./assets/void.png)

   * Resell Flow
        ![Alt text](./assets/resell.png)
