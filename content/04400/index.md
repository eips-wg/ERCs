...
Test cases are available in the reference implementation [here](./assets/test/erc721-consumable.ts).

## Reference Implementation

The reference implementation can be found [here](./assets/contracts/ERC721Consumable.sol).
