...
A solidity contract with the above test cases can be found [in the EIP asset directory](./assets/MetaProxyTest.sol).

## Reference Implementation
A reference implementation can be found [in the EIP asset directory](./assets/MetaProxyFactory.sol).
