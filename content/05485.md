...
[ERC-5247](./05247.md), the interface extends
...
2. Using [ERC-5247](./05247.md) as a base interface for enforcement proposals is backward
compatible with existing contracts that implement [ERC-5247](./05247.md), such as Multi-Sig 
...
contract's behavior. Simlar to "Ownable" ([ERC-173](./00173.md)) or "AccessControl", 
