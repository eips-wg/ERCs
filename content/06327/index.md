...
- ES can also be used as a plugin to a smart contract wallet, like Account Abstraction [ERC-4337](../04337.md). A decentralized password is picked instead of the private key. This could lead to a smooth onboarding experiences for new Ethereum Dapp users.
