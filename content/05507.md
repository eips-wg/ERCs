...
This ERC adds refund functionality for initial token offerings to [ERC-20](./00020.md), [ERC-721](./00721.md), and [ERC-1155](./01155.md). Funds are held in escrow until a predetermined time before they are claimable. Until that predetermined time passes, users can receive a refund for tokens they have purchased.
...
All implementations MUST use and follow the directions of [ERC-165](./00165.md).
...
[ERC-165](./00165.md) is required as introspection by DApps would be made significantly harder if it were not.
