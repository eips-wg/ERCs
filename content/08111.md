...
Another signature compression approach, [ERC-2098](./02098.md), stores the y-parity bit in the most-significant bit of the low `s`.
...
They cannot be used for transaction signatures because they permit high `s`, in violation of [EIP-2](./00002.md).
