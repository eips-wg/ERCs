...
This proposal builds on [ERC-1155](./01155.md) and creates a standard for referring relationships and quantifiable attributes between non-isolated [ERC-721](./00721.md) or [ERC-1155](./01155.md) non-fungible tokens (NFTs). It enables users to build a graph of NFTs and set quantifiable attributes for each NFT, facilitating more complex NFT ecosystems. While a similar proposal exists for [ERC-721](./00721.md) tokens, it does not provide a way to establish quantifiable relationships or object attributes.
...
This proposal aims to address this issue by extending the [ERC-721](./00721.md) and [ERC-1155](./01155.md) standards to include the ability to establish referring relationships and quantifiable attributes between NFTs.
...
This EIP proposes the addition of five new functions to the [ERC-721](./00721.md) and [ERC-1155](./01155.md) standards: `setRelationship`, `setAttribute`, `getRelationship`, `getAttribute`, and `getAttributeNames`. These functions allow users to establish referring relationships and set quantifiable attributes between NFTs.
...
This EIP is designed to be fully backward-compatible with existing [ERC-721](./00721.md) and [ERC-1155](./01155.md) contracts and tokens. Existing NFT contracts and tokens will continue to function as they did before, and the new `setRelationship` and `setAttribute` functions will only be available to contracts that explicitly implement this EIP.
...
### [ERC-165](./00165.md) Interface Support
