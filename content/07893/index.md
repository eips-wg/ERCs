...
![main](./assets/images/diagrams/main.svg)
...
Compliant implementations MUST implement the [ERC-165](../00165.md) `supportsInterface` function and MUST return `true` for the `ISolvencyProof` interface ID.
...
![risk-thresholds](./assets/images/diagrams/risk-thresholds.svg)
...
![threshold-levels](./assets/images/diagrams/threshold-levels.svg)
...
![oracle-integration](./assets/images/diagrams/oracle-integration.svg)
