...
## Abstract
The wrapped deposit contract handles deposits of assets (Ether, [ERC-20](./00020.md), [ERC-721](./00721.md)) on behalf of a user. A user must only approve a spend limit once and then an asset may be deposited to any number of different applications that support deposits from the contract.
