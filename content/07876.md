...
### 1. Compatibility with [EIP-3085](./03085.md)

This standard aligns with [EIP-3085](./03085.md), the Ethereum standard for wallet Add Ethereum Chain requests, wherever applicable. However, it diverges in scenarios where EIP-3085's rigid structure limits future enhancements.
...
Below is an example configuration for an [ERC-721](./00721.md) project deployed to Ethereum Mainnet and Sepolia. This illustrates how the standard can represent multi-network setups.
...
Example of an extension that **MUST** be supported: incorporating additional attributes to support [ERC-1967](./01967.md) transparent proxies and [ERC-165](./00165.md) interface identification.
