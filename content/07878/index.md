...
This EIP is compatible with existing token standards like [ERC-20](../00020.md), [ERC-721](../00721.md) and [ERC-1155](../01155.md). It can be implemented alongside these standards without affecting their core functionality.


## Test Cases

Tests are included in [`Bequeath.test.js`](./assets/test/Bequeath.test.js).


## Reference Implementation

See [`Bequeathable.sol`](./assets/contracts/Bequeathable.sol)
