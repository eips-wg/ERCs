...
#### [ERC-6372](./06372.md): clock and CLOCK_MODE
...
This signature should follow the [EIP-712](./00712.md) format:
...
where `DOMAIN_SEPARATOR` is defined according to [EIP-712](./00712.md). The `DOMAIN_SEPARATOR` should be unique to the contract and chain to prevent replay attacks from other domains,
