...
* Game developers could share an [ERC-1155](./01155.md) contract where each developer manages tokens under a specified scope.
...
**Standards**
- [ERC-1155 Multi Token Standard](./01155.md)
