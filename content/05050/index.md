...
They can be implemented using a modified version of [EIP-1820](../01820.md#erc-1820-registry-smart-contract) that allows [EIP-173](../00173.md) contract owners to call `setManager()`.
...
Interactive NFTs are likely to update their metadata in response to certain actions and developers MAY want to implement [EIP-4906](../04906.md) event emitters.
...
A reference implementation is included in `../assets/eip-5050` with a simple stateless example [`ExampleToken2Token.sol`](./assets/ExampleToken2Token.sol), and a stateful example [`ExampleStateContract.sol`](./assets/ExampleStateContract.sol)
