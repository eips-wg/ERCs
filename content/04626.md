...
representing shares of a single underlying [EIP-20](./00020.md) token.
...
All [EIP-4626](./04626.md) tokenized Vaults MUST implement EIP-20 to represent shares.
...
EIP-4626 tokenized Vaults MAY implement [EIP-2612](./02612.md) to improve the UX of approving shares on various integrations.
