...
The **metadata extension** is OPTIONAL for [EIP-7765](../07765.md) smart contracts. This allows your smart contract to be interrogated for its details about the privileges which your NFTs carry.
...
The reference implementation of Privileged NFTs can be found [Here](./assets/contracts/ERC7765Example.sol).
