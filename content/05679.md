...
Some implementations of [EIP-721](./00721.md) and [EIP-1155](./01155.md)
...
1. Any contract complying with [EIP-20](./00020.md) when extended with this EIP,
...
2. Any contract complying with [EIP-721](./00721.md) when extended with this EIP,
**MUST** implement the following interface:
...
3. Any contract complying with [EIP-1155](./01155.md) when extended with this EIP,
**MUST** implement the following interface:
...
[EIP-721](./00721.md) and [EIP-1155](./01155.md).

7. It's RECOMMENDED for the client to implement [EIP-165](./00165.md) identifiers as specified above.
...
2. We have chosen to identify the interface with [EIP-165](./00165.md) identifiers each individually,
...
5. We have not add extension for [EIP-777](./00777.md) because it already handles Minting and Burning.
