...
Designs that use datatypes with small widths than `bytes32` (such as `bytes1` in [ERC-1066](./01066.md)) can be directly embedded into the larger width. This is a trivial one-to-one mapping of the smaller set into the larger one.
