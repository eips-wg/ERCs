...
An extension of the [ERC-721 standard](./00721.md) to enable ERC-721 tokens to own other ERC-721 tokens and [ERC-20](./00020.md) tokens.

An extension of the [ERC-20](./00020.md) and `ERC-223 https://github.com/ethereum/EIPs/issues/223` standards to enable ERC-20 and `ERC-223` tokens to be owned by ERC-721 tokens.
...
`ERC998ERC721` top-down, `ERC998ERC20` top-down, and `ERC998ERC721` bottom-up composable contracts must implement the [ERC-721 interface](./00721.md).

### ERC-20

`ERC998ERC20` bottom-up composable contracts must implement the [ERC-20 interface](./00020.md).

### [ERC-165](./00165.md)

The [ERC-165 standard](./00165.md) must be applied to each [ERC-998](./00998.md) interface that is used.
...
/// @dev See https://github.com/ethereum/EIPs/blob/master/EIPS/./00998.md
