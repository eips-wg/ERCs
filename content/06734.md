...
<a name="d2"> **[D2]** </a>
The `chainId` property SHOULD follow [EIP-3220](./03220.md) draft standard.

[[D2]](#d2) testability: The [EIP-3220](./03220.md) draft standard can be tested because the crosschain id is specified as a concatenation of well-defined strings, and using open source tooling can be used to parse and split a crosschain id, the obtained string segments can be compared against expected string lengths, and context dependent, the values for the strings specified in the standard. Consequently, [[D2]](#d2) is testable.
