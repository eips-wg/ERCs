...
This standard is an extension of [ERC-721](./00721.md). It defines new validation functionality to avoid wallet draining: every `transfer` or `approve` will be locked waiting for validation.
...
[ERC-721](./00721.md) compliant contracts MAY implement this EIP.
...
This standard is an extension of [ERC-721](./00721.md), compatible with all the operations except `transferFrom`/`safeTransferFrom`/`approve`/`setApprovalForAll`.
