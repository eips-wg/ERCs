...
The [ERC-7730](../07730.md) specification enriches type data contained in the ABIs and schemas of structured messages (structures like the calldata of an EVM transaction or an [EIP-712](../00712.md) message) with additional formatting information, so that wallets can construct a better UI when displaying the data before signature. For instance, a solidity field containing an amount, encoded as an uint256, can be converted to the right magnitude and appended with the correct ticker.
...
In the future, this specification could be extended to structured data like Meta Transaction in [EIP-2771](../02771.md) or User Operations in [EIP-4337](../04337.md).

## Test Cases

More examples can be found in the asset folder [here](./assets/example-main.json) and [here](./assets/example-include.json).
...
![Curation Model](./assets/curation-model.svg)
