...
The current version of the specification is `1` at the time of writing. The reference schema for version `1` is [here](./assets/erc7730-v1.schema.json).
