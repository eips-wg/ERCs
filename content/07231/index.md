...
![EIP Flow Diagram](./assets/img/Identity-aggregated-NFT-flow.png)
...
1. Verify the binding relationship between data on-chain and off-chain data through signature based on [ERC-1271](../01271.md)
Through the signature method based on the [ERC-1271](../01271.md) protocol, the verifyIdentiesBinding function of this EIP realizes the binding of the userID and NFT owner address between on-chain and off-chain.
...
As mentioned in the specifications section, this standard can be fully [ERC-721](../00721.md) compatible by adding an extension function set.
In addition, new functions introduced in this standard have many similarities with the existing functions in [ERC-721](../00721.md). This allows developers to easily adopt the standard quickly.

## Test Cases

Tests are included in [`erc7231.ts`](./assets/test/erc7231.ts).
...
`ERC7231.sol` Implementation: [`ERC7231.sol`](./assets/contracts/ERC7231.sol)
