...
Any ENS name can resolve to a chain identifier as specified in <!-- TODO: Is 2304 a sufficient replacement for ENSIP-11? -->[ERC-2304](./02304.md). The name should resolve to a record containing not only the chain identifier, but also all the optional information necessary to verify the identifier.
