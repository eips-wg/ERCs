...
## Motivation
Non-fungible tokens are popularized by the [ERC-721](./00721.md) NFT standard
...
## Rationale
The NFTs defined in the [ERC-721](./00721.md) standard are already largely
...
from [ERC-721](./00721.md), data fields and functions related to `URI` are
excluded.
