...
[ERC-721](./00721.md) and [ERC-1155](./01155.md), the ordering information of 
multiple NFTs is discarded. However, as proposed in [EIP-3754](./03754.md), 
...
language. This illustrates the key difference between this standard and [ERC-1155](./01155.md).
...
## Rationale
In [ERC-1155](./01155.md) and [ERC-721](./00721.md), NFTs are used to represent
crypto-assets, and in this standard together with [EIP-3754](./03754.md), NFTs
...
is kept in storage and hence additional storage than [ERC-1155](./01155.md) is required.

## Backwards Compatibility
[EIP-3754](./03754.md) is the pre-requisite to this standard.
