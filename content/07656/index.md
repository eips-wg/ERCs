...
The registry MUST deploy each token-linked service as an [ERC-1167](../01167.md) minimal proxy with immutable constant data appended to the bytecode, like existing token-bound account proposals.
