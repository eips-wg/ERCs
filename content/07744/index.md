...
Reference implementation of the Code Index can be found in the assets folder. There you can find the [interface](./assets/ICodeIndex.sol) and the [implementation](./assets/CodeIndex.sol) of the Code Index.
