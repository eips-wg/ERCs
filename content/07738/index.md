...
[ERC-5169](../05169.md) provides a client script lookup method for contracts. This requires the contract to have implemented the `ERC-5169` interface at the time of construction (or allow an upgrade path).
...
Instructions for test harness and deployment can be found in the [Asset folder](./assets/tests.md).
