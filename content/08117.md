...
**Gas Optimization ([EIP-7939](./07939.md)):** With proposals like EIP-7939 aiming to reduce gas costs for zero bytes in calldata, there is an economic incentive to deploy contracts at addresses containing large sequences of zeros to optimize cross-contract call costs.
...
### 3. Case Sensitivity and [EIP-55](./00055.md)

To preserve the checksum integrity defined in EIP-55 and [EIP-1191](./01191.md):
