...
1. **MUST** implement [ERC-20](../00020.md)
2. **MUST** implement [ERC-165](../00165.md)
...
- [ERC-5679](../05679.md) compliant `mint(address, uint256, bytes)`
...
#### Ownership (via [ERC-173](../00173.md))

Implementations that want a single-owner governance model MAY use [ERC-173](../00173.md) or [ERC-8023](../08023.md) for standardized ownership.
...
This standard is fully backwards compatible with [ERC-20](../00020.md). In fact, **any existing ERC-20 token can be used as a Group** — the standard simply defines how to interpret token balance as membership.

## Reference Implementation

Reference contracts are provided in the `assets/` directory:

- [`IERC8063.sol`](./assets/IERC8063.sol) — Interface definition
- [`ERC8063.sol`](./assets/ERC8063.sol) — Reference implementation with membership helpers
