...
Cryptography 2 (SEC 2) v2](./assets/sec2-v2.pdf), page 9.
...
Cryptography 1 (SEC 1) v2](./assets/sec1-v2.pdf). Point compression is used. We use the notation $\mathsf{sec1}(pk)$ to denote the compressed encoding of secp256k1 curve point $pk$ as a bytestring of length 33.
