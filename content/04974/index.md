...
This standard is influenced by the [EIP-20](../00020.md) and [EIP-721](../00721.md) token standards and takes cues from each in its structure, style, and semantics.
...
We chose Standard Interface Detection ([EIP-165](../00165.md)) to expose the interfaces that a compliant smart contract supports.
