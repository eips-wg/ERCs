...
This specification is an optional extension of [ERC-721](../00721.md).
...
Every contract compliant with [ERC-6785](../06785.md) MUST implement the interface defined as follows:
...
Test cases are available [here](./assets/test/ERC6785.test.js)

## Reference Implementation

The reference implementation can be found [here](./assets/contracts/ERC6785.sol).
