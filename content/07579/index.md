...
- **EntryPoint** - A trusted singleton contract according to [ERC-4337](../04337.md) specifications.
...
- MUST utilize [ERC-2771](../02771.md) to add the original `msg.sender` to the `calldata` sent to the fallback handler
...
A full interface of a smart account can be found in [`IMSA.sol`](./assets/IMSA.sol).
