...
documentation [`ILockingContract.sol`](./assets/contracts/ILockingContract.sol).
...
documentation [`IDecryptionContract.sol`](./assets/contracts/IDecryptionContract.sol).
...
![sequence diagram dvp](./assets/doc/DvP-Seq-Diag.png)
...
In Delivery-versus-Payment (DvP) protocols like [ERC-7573](../07573.md), at least one token must be locked to ensure atomicity, even if only for a short period during the transaction.
...
#### N-DvP with [ERC-7573](../07573.md)

A multi-party DvP can be created elegantly by combining multiple (*n-1*) two-party DvPs, for example based on the [ERC-7573](../07573.md) protocol.
...
Below we depict the corresponding sequence diagram of a multi-party DvP via [ERC-7573](../07573.md).
...
![sequence diagram multi party dvp](./assets/doc/multi-party-dvp.svg)
...
![sequence diagram distributed oracle](./assets/doc/Distributed-Oracle.png)
