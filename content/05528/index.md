...
This standard is an extension of [EIP-20](../00020.md). This specification defines a type of escrow service with the following flow:
...
- *Payable Contract*: The sellers and buyers use this token to fund the *Escrow Contract*. This contract MUST override [EIP-20](../00020.md) interfaces.
- *Escrow Contract*: Defines the escrow policies and holds *Payable Contract*'s token for a certain period. This contract does not requires override [EIP-20](../00020.md) interfaces.
...
The *Payable Contract* which implements this EIP is fully backward compatible with the [EIP-20](../00020.md) specification.

## Test Cases

[Unit test example by truffle](./assets/truffule-test.js).
