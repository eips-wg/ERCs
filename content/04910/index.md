...
The proposal directly connects NFTs and royalties in a smart contract architecture extending the [ERC-721](../00721.md) standard, with the aim of precluding central authorities from manipulating or circumventing payments to those who are legally entitled to them.
...
The payment process depends on whether the payment is received in ETH or an [ERC-20](../00020.md) token:
