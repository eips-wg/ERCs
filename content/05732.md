...
8. It is RECOMMENDED for compliant contracts to implement [EIP-165](./00165.md).
...
7. There is potential for replay attacks across different chainIds or chains resulting from forks. In these cases, the chainId must be included in the generation of commitment. For applications with a higher risk of replay attacks, implementors should consider battle-tested and cryptographically-secure solutions such as [EIP-712](./00712.md) to compose commitments before creating their own new solution.
