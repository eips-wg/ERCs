...
This EIP proposes a standardized approach to declaring mining preferences for digital media content on the EVM-compatible blockchains. This extends digital media metadata standards like [ERC-7053](./07053.md) and NFT metadata standards like [ERC-721](./00721.md) and [ERC-1155](./01155.md), allowing asset creators to specify how their assets are used in data mining, AI training, and machine learning workflows.
...
The following is an example of using the `dataMiningPreference` property in [ERC-721](./00721.md) NFTs.
...
The example using the `dataMiningPreference` property in onchain media provenance registration defined in [ERC-7053](./07053.md).
