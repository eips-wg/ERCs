...
The following standard formalizes the Series Accounting Method for [ERC-7540](./07540.md) and [ERC-4626](./04626.md) type vaults, enabling them to collect performance fees on yields without introducing the free-rider problem.
...
[ERC-8113](./08113.md) vaults MUST allow users to redeem (or request a redeem) by providing `assets` instead of `shares` as input.
