...
The Parent-Governed Nestable NFT standard extends [ERC-721](../00721.md) by allowing for a new inter-NFT relationship and interaction.
...
![Nestable tokens](./assets/img/eip-6059-nestable-tokens.png)
...
1. **Reject child token**\
![Reject child token](./assets/img/eip-6059-reject-child.png)
2. **Abandon child token**\
![Abandon child token](./assets/img/eip-6059-abandon-child.png)
3. **Unnest child token**\
![Unnest child token](./assets/img/eip-6059-unnest-child.png)
4. **Transfer the child token to an EOA or an `ERC721Receiver`**\
![Transfer child token to EOA](./assets/img/eip-6059-transfer-child-to-eoa.png)
5. **Transfer the child token into a new parent token**\
![Transfer child token to parent token](./assets/img/eip-6059-transfer-child-to-token.png)\
