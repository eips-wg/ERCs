...
This EIP standardizes a schema for NFTs metadata to add new field namespaces to the JSON schema for [EIP-721](../00721.md) and [EIP-1155](../01155.md) NFTs.
...
The same security considerations as with [EIP-721](../00721.md) apply related to using http gateways or IPFS for the tokenURI method.
