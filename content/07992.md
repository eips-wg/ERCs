...
In short, this ERC turns verifiable ML inference into a reusable primitive—doing for AI outputs what [ERC-20](./00020.md)/[ERC-721](./00721.md) did for assets.
...
(e.g., simple owner storage, [ERC-173](./00173.md), [ERC-721](./00173.md) representation, or role-based control). 
...
- Uses [ERC-165](./00165.md) like popular [ERC-721](./00721.md) or [ERC-1155](./01155.md) for discoverability.
