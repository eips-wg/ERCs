...
This standard is an extension to [EIP-721](../00721.md). It proposes a multi-layer filesystem-like hierarchical NFTs. This standard provides interfaces to get parent NFT or children NFTs and whether NFT is a leaf node or root node, maintaining the hierarchical relationship among them.
...
![Linux Hierarchical File Structure](./assets/linux-hierarchy.png)
...
![Website Hierarchical Structure](./assets/website-hierarchy.png)
...
Every compliant contract must implement this proposal, [EIP-721](../00721.md) and [EIP-165](../00165.md) interfaces.
...
Implementation: [EIP-6150](./assets/contracts/ERC6150.sol)
