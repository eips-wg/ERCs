...
- **[ERC-721](./00721.md):** Each post should be a unique (`tokenId`).
- **[ERC-1155](./01155.md):** A `tokenId` should only represent one post event even if minted multiple times.

#### Backwards Compatibility

This is an additive standard on top of [ERC-721](./00721.md) and [ERC-1155](./01155.md). Existing NFTs remain compatible; clients or platforms that understand this standard can interpret these tokens as social posts as well as traditional NFTs.
