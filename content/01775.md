...
These app keys can then be endowed a different set of permissions (through the requestPermission model introduced in [EIP-2255](./02255.md)). This will potentially allow an user to partly trust some apps to perform some crypto operations on their behalf without compromising any security with respect to her main accounts.

## Motivation
Wallets developers have agreed on an HD derivation path for ethereum accounts using BIP32, BIP44, SLIP44, [(see the discussion here)](https://github.com/ethereum/EIPs/issues/84). Web3 wallets have implemented in a roughly similar way the rpc eth api. [EIP-1102](./01102.md) introduced privacy through non automatic opt-in of a wallet account into an app increasing privacy.
...
[EIP1581: Non-wallet usage of keys derived from BIP32 trees](./01581.md)
...
* [SLIP44: Registered coin types for BIP44](https://github.com/satoshilabs/slips/blob/master/./00044.md)
...
* [EIP600 Ethereum purpose allocation for Deterministic Wallets](./00600.md)


* [EIP601 Ethereum hierarchy for deterministic wallets](./00601.md)
...
* [EIP1102: Opt-in account exposure](./01102.md)

* [EIP1581: Non-wallet usage of keys derived from BIP-32 trees](./01581.md)

* [EIP1581: discussion](https://ethereum-magicians.org/t/non-wallet-usage-of-keys-derived-from-bip-32-trees/1817/4)

* [SLIP13: Authentication using deterministic hierarchy](https://github.com/satoshilabs/slips/blob/master/./00013.md)
