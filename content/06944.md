...
This EIP adds a new [ERC-4804](./04804.md) `resolveMode` to resolve [ERC-5219](./05219.md) contract resource requests.
...
[ERC-165](./00165.md) was not used because interoperability can be checked by calling `resolveMode`.
...
The security considerations of [ERC-4804](./04804.md#security-considerations) and [ERC-5219](./05219.md#security-considerations) apply.
