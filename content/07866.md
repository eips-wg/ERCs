...
6. **Compatibility with Existing Standards**
   - The profile standard integrates with [ERC-165](./00165.md) for interface detection and can complement ENS or other naming systems, fostering interoperability rather than competition.
...
4. **Non-SBT-Based Implementation**
   - Using standard [ERC-721](./00721.md) tokens for profiles was considered but rejected since transferability is unsuitable for identity management. SBTs enforce the immutability of identity ownership.

### Comparison with Related Work

- **[ERC-137](./00137.md) (ENS)**: Provides a robust naming service but lacks dApp-specific metadata and cross-chain functionality.
...
- **ENS Compatibility**: The system adheres to the naming conventions and standards specified in [ERC-137](./00137.md) (Ethereum Name Service). This ensures that any dApps or tools already using ENS-compatible names can easily integrate profiles without additional changes.
