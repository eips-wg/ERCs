...
1. **Attempt calling a URI** if the app supports [URL format for transaction requests EIP](./00681.md) then attempt calling this. This can be automatic or prompted by user action.
