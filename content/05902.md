...
For this reason, it is recommended to use [ERC-721](./00712.md) Typed Data Signatures.  In this case the process that initiates the hook should create the signature according to the following data structure:
