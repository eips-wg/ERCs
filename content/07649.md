...
Non-Fungible Tokens (NFTs) without modifying the [ERC-721](./00721.md) standard.
...
4.  Payment Mechanisms:
    - The embedded liquidity contract MUST support either [ERC-20](./00020.md) tokens or native ETH as a payment,
      it MAY support both.
