...
This extension adds a renewable allowance mechanism to [ERC-20](../00020.md) allowances, in which a `recoveryRate` defines the amount of token per second that the allowance regains towards the initial maximum approval `amount`.
...
An minimal implementation is included [here](./assets/ERC5827.sol)
