...
The registry serves as the **trust and delegation module** anticipated by [ERC-8001](../08001.md), enabling coordinators to gate participation based on trust graph proximity. An agent is considered valid from a coordinator's perspective if sufficient trust paths exist between them.

This standard specifies trust attestation structures, the path verification algorithm, ENS integration semantics, and [ERC-8001](../08001.md) coordination hooks.

## Motivation

[ERC-8001](../08001.md) defines minimal primitives for multi-party agent coordination but explicitly defers trust to modules:
...
* [EIP-712](../00712.md) typed data for signing attestations
* [EIP-1271](../01271.md) support for contract controllers
* The `ITrustRegistry` interface
* Path verification algorithm
* [ERC-8001](../08001.md) integration hooks
...
* For contract owners: any signer the contract validates via [EIP-1271](../01271.md)
...
Implementations MUST use the following [EIP-712](../00712.md) domain:
...
Implementations SHOULD expose the domain via [EIP-5267](../05267.md).
...
This function gates [ERC-8001](../08001.md) coordination participation.
...
For [ERC-8001](../08001.md) identity gates:
...
ENS is finalised [EIP-137](../00137.md), battle-tested, and widely adopted. Creating a new identity system would:
...
**Wallet Compatibility**: Uses [EIP-712](../00712.md) signatures, compatible with all major wallets. Supports [EIP-1271](../01271.md) for contract wallets and smart accounts.

## Reference Implementation

See [`contracts/TrustRegistry.sol`](./assets/contracts/TrustRegistry.sol) for the complete implementation.
...
[EIP-712](../00712.md) domain binding prevents cross-contract replay. Monotonic nonces prevent replay within the same contract. The `chainId` in the domain prevents cross-chain replay.
