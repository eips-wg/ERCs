...
Current LP (Liquidity Provider) tokens are simple [EIP-20](../00020.md) tokens with no complex data structure. To allow more complex reward and redemption logic to be stored on-chain, we need a new token standard that:
...
However, any existing [EIP-20](../00020.md) token contract can issue its bonds by delegating the minting role to a bank contract with the interface of this standard built-in. Check out our reference implementation for the correct interface definition.
...
**Note that the this standard interface is also compatible with [EIP-20](../00020.md) and [EIP-721](../00721.md) and [EIP-1155](../01155.md)interface.**

However, creating a separate bank contract is recommended for reading the bonds and future upgrade needs.

Acceptable collateral can be in the form of fungible (like [EIP-20](../00020.md)), non-fungible ([EIP-721](../00721.md), [EIP-1155](../01155.md)) , or other bonds represented by this standard.
