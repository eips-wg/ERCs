...
according to [EIP-191](./00191.md), with the *version
...
- The signTypedData [EIP-712](./00712.md) has many parallels to what this EIP aims to solve
...
All signatures for messages are generated using [EIP-191](./00191.md)
