...
Abstract tokens can comply with existing standards like [ERC-20](../00020.md), [ERC-721](../00721.md), and [ERC-1155](../01155.md). The standard allows wallets and other applications to better handle *potential* tokens before any consensus-dependent events occur on-chain.
...
All abstract token contracts must support [ERC-165](../00165.md) and include the Abstract Token interface ID in their supported interfaces.
