...
Compliant contracts MUST implement [ERC-165](../00165.md) and return `true` when queried for the `IScaledUIAmount` interface ID.
...
1. ERC-165 Support: Compliant contracts MUST implement [ERC-165](../00165.md) interface detection.
...
![Token Value Representation Approaches](./assets/token_value_repr.jpeg)

![Token Architecture Layers](./assets/token_arch_layers.jpeg)
