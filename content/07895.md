...
This ERC conforms to <!-- TODO: [ERC-7846](./07846.md) --> which includes [ERC-5792](./05792.md) capabilities specification and introduces two new capabilities for `wallet_connect`. 
...
This ERC conforms with `wallet_getCapabilities` [ERC-5792](./05792.md). The response will accommodate addSubAccount support for wallets that support it.
...
This standard builds on existing JSON-RPC methods and complements [ERC-5792](./05792.md) for future extensibility. Wallets can continue supporting legacy methods.
