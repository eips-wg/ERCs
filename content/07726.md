...
For ETH, the address will be `0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE` as per [ERC-7528](./07528.md).
...
difficult representation. The popular option for representing prices can be implemented for [ERC-20](./00020.md) with decimals as
