...
This EIP extends [ERC-5114](../05114.md) to further enable transferring fund to other accounts for mobility between managing multiple wallets.
...
1. It SHALL be non-fungible and MUST satisfy [ERC-721](../00721.md).
...
![Diagram](./assets/media/media.svg)
...
[Reference implementation](./assets/README.md) is a simple deposit account contract as `Finance` contract and its contribution value α is measured with deposit amount with ETH.
