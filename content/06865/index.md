...
![](./assets/current-EIP-712-signature-wallet-interface.png)
...
![](./assets/vision-EIP-712-signature-wallet-interface.png)
...
- `assetTokenAddress` is the token ([ERC-20](../00020.md), [ERC-721](../00721.md), [ERC-1155](../01155.md)) smart contract address where the zero address MUST represents the Native coin (Native ETH in the case of Ethereum network).
...
openSea Seaport NFT marketplace implementation example is available [here](./assets/contracts/SeaPortEIP712Visualizer.sol)
