...
Every contract compliant with [ERC-6786](../06786.md) MUST implement the interface defined as follows:
...
For fetching creator on-chain data we will use [ERC-2981](../02981.md), but any other on-chain method of getting the creator address is accepted.
...
Tests are included in [`ERC6786.test.js`](./assets/test/ERC6786.test.js).
...
See [`ERC6786.sol`](./assets/contracts/ERC6786.sol).
