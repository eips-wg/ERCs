...
![diagram showing relationship between accounts and modules with modular functions](./assets/MSCA_Shared_Components_Diagram.svg)
...
![diagram showing call flow within a modular account](./assets/Modular_Account_Call_Flow.svg)
...
Module interface. Modules MUST implement this interface to support module management and interactions with [ERC-6900](../06900.md) modular accounts.
