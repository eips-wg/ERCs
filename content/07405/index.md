...
![Overview Diagram](./assets/overview-diagram.jpg)
...
The signature is created using **[ERC-191](../00191.md)**, signing the **`MigrateOpHash`** (calculated as **`abi.encode(chainID, selector, data)`**).
